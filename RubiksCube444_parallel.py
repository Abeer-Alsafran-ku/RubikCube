...
class LookupTable444UDCentersStage(LookupTable):
    ...
    def state(self) -> str:
        ...
        center_groups = [centers_444[i:i + cpu_count()] for i in range(0, len(centers_444), cpu_count())]
        
        # Process center groups in parallel
...
class LookupTableIDA444Phase3(LookupTableIDAViaGraph):
    ...
    def search(self, state):
        ...
        move_groups = [moves_444[i:i + cpu_count()] for i in range(0, len(moves_444), cpu_count())]
